import { ReplaceInstruction, ReplaceTextRecipe, TextUtil } from "./util/text-util";
...
function pupulate(fuck: (x: string) => string) {
...
TextUtil.replaceText("/home/huseyin/Belgeler/Dev/Tetakent/lotus-web", [
    ...pupulate((a) => "from \"" + a + "\""), 
    ...pupulate((a) => "from '" + a + "'"), 
