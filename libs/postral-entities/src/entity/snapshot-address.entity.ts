 ...
 * @deprecated
 * 
 * eski versiyonlardan migrate edilirken kullanılıyor. Yeni versiyonda SnapshotAddress kullanılacak.
 */
@Entity({ name: 'invoice_address' })
export class InvoiceAddressLegacy {
    @PrimaryGeneratedColumn('uuid')
    id!: string;
